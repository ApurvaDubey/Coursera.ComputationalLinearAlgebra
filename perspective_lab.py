...
def make_nine_equations(corners):
    ...
    u_01 = make_equations(corners[0][0],corners[0][1],0,0)    
    
    u_23 = make_equations(corners[1][0],corners[1][1],0,1)
    
    u_45 = make_equations(corners[2][0],corners[2][1],1,0)
   
    u_67 = make_equations(corners[3][0],corners[3][1],1,1)

    return [u_01[0],u_01[1],u_23[0],u_23[1],u_45[0],u_45[1],u_67[0],u_67[1],w]

#corners = [(12,13),(14,15),(16,17),(18,19)]
#print (make_nine_equations(corners))
...
L = rowdict2mat(make_nine_equations(((358,36),(329,597),(592,157),(580,483))))
