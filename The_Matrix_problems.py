...
small_mat_mult_3 = [[6,2],[-4,12],[1,-1]]
small_mat_mult_4 = [1,4,9]
...
your_answer_e_AB = [[0,3,2,8],[0,-9,0,2],[0,0,0,8],[0,15,0,-2]]
...
# A*B = Mat(({0,1,2}, {'x','y'}), {(0,'y'):-5, (1,'x'):3, (1,'y'):-2, (2,'x'):-5})
...
for i in A.D[0]:
    #print (i, A_row[i]*B)
    final_tmp[i]=A_row[i]*B

#print (final_tmp)

for k,v in final_tmp.items():
    final[k]=Vec(v.D, {k2:v2 for k2,v2 in v.f.items() if v2 != 0 })
    
prod =  (rowdict2mat(final))
#print (prod.f)
